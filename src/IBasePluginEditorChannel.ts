...
export type IBasePluginEditorChannelCallback = (obj: PluginParameterJSONEntry) => void;
...
export type IParametersListenerCallback = (obj: PluginParameterJSON) => void;
...
export interface IBasePluginEditorChannel {
    ...
    setParametersByObject(object: {name: string, value: any}[]): void
    ...
    sendCustomEvent(type, payload): void
}